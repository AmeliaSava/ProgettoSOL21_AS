...
./client -p -f storage_sock.sk -t 200 -W ./storage1/Images/1kb.png -w ./storage2 -l ./storage1/Images/1kb.png -c ./storage1/Images/1kb.png -l ./storage2/append.txt -u ./storage2/append.txt -D ./expelled
./client -p -f storage_sock.sk -t 200 -w ./storage1 -r ./storage2/prova.txt -R -d ./savedfiles  
./client -h
